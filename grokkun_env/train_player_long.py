...
from grokkun_env.train_player import PlayerMLP, evaluate
...
def shaped_reward(env: Grokkun26Env, base: float, done: bool) -> float:
...
def collect(env: Grokkun26Env, net: ActorCritic, max_steps: int) -> tuple[Batch, float]:
    batch = Batch()
    env.reset()
